...
const ALERT_THRESHOLDS: Record<OpsEventCode, number> = {
  API_SLOW_REQUEST: Number.parseInt(process.env.OPS_ALERT_API_SLOW_REQUEST_THRESHOLD ?? "30", 10) || 30,
  API_5XX_RESPONSE: Number.parseInt(process.env.OPS_ALERT_API_5XX_RESPONSE_THRESHOLD ?? "8", 10) || 8,
