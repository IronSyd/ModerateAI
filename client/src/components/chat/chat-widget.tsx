...
const ChatWidget = () => {
  ...
  const generateDemoResponse = (userInput: string): string => {
    ...
    // Original fallback responses for other topics
      ...
      return "ModerateAI offers multi-platform integration, intelligent content moderation, and customizable AI configurations. Is there a specific feature you'd like to know more about?";
      ...
      return "ModerateAI is a powerful SaaS platform designed for AI-powered customer support and community moderation across various digital channels. Key features include multi-platform support for websites, Telegram, and Discord; intelligent, AI-powered responses using OpenAI technology; and automatic content filtering and moderation based on customizable settings. Additionally, it offers knowledge base integration to help provide accurate and consistent responses.";
    } else if (input.includes("report") || input.includes("data") || input.includes("performance")) {
      return "Our platform provides detailed reporting on your conversations and moderation actions. You can track key metrics such as response times, common topics, and moderation efficiency across all platforms. The system helps identify trending questions and potential issues, allowing you to proactively address customer concerns. All conversation data is securely stored and easily accessible for your team to review and analyze.";
