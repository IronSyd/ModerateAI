...
const ChatWidget = () => {
  ...
  const generateDemoResponse = (userInput: string): string => {
    ...
    } else if (input.includes("integration") || input.includes("connect") || input.includes("setup") || input.includes("install") || input.includes("implement") || input.includes("how does the multi-platform work")) {
    ...
    } else if (input.includes("ai") || input.includes("model") || input.includes("assistant") || input.includes("chatbot") || input.includes("intelligence") || input.includes("customize the ai")) {
    ...
    } else if (input.includes("moderation") || input.includes("moderate") || input.includes("filter") || input.includes("content") || input.includes("set up content moderation") || input.includes("discord server")) {
    ...
    } else if (input.includes("analytics") || input.includes("report") || input.includes("data") || input.includes("performance") || input.includes("analytics features")) {
    ...
    } else if (input.includes("knowledge base") || input.includes("kb") || input.includes("knowledge") || input.includes("information") || input.includes("create a knowledge base")) {
    ...
    } else if (input.includes("languages") || input.includes("language") || input.includes("multilingual") || input.includes("translate") || input.includes("what languages")) {
    ...
    } else if (input.includes("detect") || input.includes("inappropriate") || input.includes("content") || input.includes("what types of inappropriate")) {
