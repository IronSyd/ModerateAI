    ...
    <div className="space-y-6 wave-v2-page wave-v2-integrations">
      <div className="wave-v2-hero rounded-2xl border p-5 md:p-6 flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl sm:text-3xl font-semibold text-foreground">Discord Integration</h1>
        ...
        <div className="mb-6 overflow-x-auto pb-1">
          <TabsList className="glass-chip w-max min-w-full sm:min-w-0">
            <TabsTrigger value="setup" className="whitespace-nowrap px-2 text-xs sm:px-3 sm:text-sm">
              <MessageSquareMore className="h-4 w-4 mr-1 sm:mr-2" />
            Setup
            </TabsTrigger>
            <TabsTrigger value="channels" disabled={!platform} className="whitespace-nowrap px-2 text-xs sm:px-3 sm:text-sm">
              <Hash className="h-4 w-4 mr-1 sm:mr-2" />
            Servers
            </TabsTrigger>
            <TabsTrigger value="settings" disabled={!hasClaimedDiscordServer} className="whitespace-nowrap px-2 text-xs sm:px-3 sm:text-sm">
              <Settings className="h-4 w-4 mr-1 sm:mr-2" />
            Settings
            </TabsTrigger>
            <TabsTrigger value="analytics" disabled={!hasClaimedDiscordServer} className="whitespace-nowrap px-2 text-xs sm:px-3 sm:text-sm">
