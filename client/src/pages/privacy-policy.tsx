...
export default function PrivacyPolicyPage() {
  ...
  const { title, description, markdown, contactEmail } = privacyPolicyContent;
      ...
      <div className="min-h-screen bg-background px-4 py-10 md:py-14">
        <div className="mx-auto max-w-4xl">
          <Card className="glass-card border-red-500/30">
            <CardHeader>
              <CardTitle>Privacy Policy Unavailable</CardTitle>
              <CardDescription>
                The privacy policy content could not be loaded in this build.
              </CardDescription>
            </CardHeader>
          ...
          <CardHeader>
            ...
            <div className="pt-2 text-sm text-muted-foreground">
              <div>
                ...
                <button
                  type="button"
                  aria-label="Copy privacy contact email"
